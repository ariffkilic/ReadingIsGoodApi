...
public class OrderRepositoryImpl implements OrderRepository {
	...
	public Order save(InsertOrderCommand command) {
		...
		OrderEntity orderEntity = orderRepository.save(RepositoryConverter.toOrderEntity(customer, books, totalAmount,books.size()));
		return RepositoryConverter.toOrder(orderEntity);
	}
	...
	public OrderDetail retrive(Long id) {
		 ...
		 return RepositoryConverter.toOrderDetail(orderEntity);
	}
	...
	public List<OrderDetail> retrive(Date startDate, Date fromDate) {
		...
		return RepositoryConverter.toOrderDetailList(orderEntityList);
	}

	@Override
	public CustomerStatistics getCustomerStatisticByMonthly(Long customerId) {
		return RepositoryConverter.toCustomerStatistics(orderRepository.getCustomerStatisticByMonthly(customerId));
	}
}
